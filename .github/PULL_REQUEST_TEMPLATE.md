...
If this touches a live Azure AI / Foundry demo, include the manual validation performed and confirm cleanup was run.
...
- [ ] Ran cleanup for any uploaded files, vector stores, or demo resources created during validation.
